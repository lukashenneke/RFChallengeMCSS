...
methods = [
    'none',
    'bf_mpdr_oracle_2ch_ULA', 
    'bf_mpdr_oracle_4ch_ULA',
    'bf_mpdr_oracle_4ch_URA',
    'wavenet', 
    'wavenet_2ch', 
    'wavenet_4ch', 
    'wavenet_4ch_URA',
    ...
    for soi_type in soi_identifier:
        for interference_sig_type in interference_identifier:
            ...
            for id_string in methods:
                ...
                all_scores[id_string] = (mse_score, ber_score)
    ...
    for k,v in keep_scores.items():
        for kk,vv in v.items():
            if kk not in final_score:
                ...
                final_score[kk] = (round(final_score[kk][0]+vv[0],2), final_score[kk][1]+vv[1])
    print('=== FINAL SCORES ===')
